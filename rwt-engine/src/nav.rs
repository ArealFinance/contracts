...
use crate::constants::INITIAL_NAV;
use crate::error::RwtError;

/// Calculate NAV (Net Asset Value) per RWT token.
///
/// Formula: NAV = total_invested_capital * 1_000_000 / total_rwt_supply
///
...
pub fn calculate_nav(capital: u128, supply: u64) -> core::result::Result<u64, ProgramError> {
    ...
    let nav = arlex_lang::math::mul_div_u128_u64(capital, 1_000_000, supply)
